<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiCode.ascx.cs" Inherits="FrmPresentation.App_Utility.MultiCode.MultiCode" %>
...
<script src="/FrmPresentation/App_Utility/Scripts/jquery-1.4.1.min.js" type="text/javascript"></script>
<script type="text/javascript" language="javascript">
    //    $(document).ready(function () {
    //        alert($(".MultiCodeClassTbMain").attr("UserControlID"));
    //    });
    //    alert(document.getElementById("_TBMain").setAttribute("UserControlID"));
    var ThisIDCode = null;
    ...
    function EndRequestHandler(sender, args) {
        ...
        var PCode
        ThisIDCode = Sys.Application._clientId;
        ThisIDCode = ThisIDCode.replace("_cmbCode", "");
