<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KCalendar.ascx.cs" Inherits="FrmPresentation.App_Utility.NewCalendar.KCalendar" %>
<script language="javascript" src="/FrmPresentation/App_Utility/NewCalendar/Script/KCalendar.js?v=1.2"></script>
<script language="javascript" src="/FrmPresentation/App_Utility/NewCalendar/Script/TextDate.js"></script>
<script language="javascript" src="/FrmPresentation/App_Utility/NewCalendar/Script/MyDate.js"></script>
<style type="text/css">
    .TxtCalendar
    {
        border-width: 0px;
