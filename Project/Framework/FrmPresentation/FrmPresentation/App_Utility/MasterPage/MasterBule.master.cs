...
namespace FrmPresentation.App_Utility.MasterPage
{
    public partial class MasterBule : System.Web.UI.MasterPage
    {
        ...
        {
            FrmDAL.App_Classes.GeneralDAL ODAL = new FrmDAL.App_Classes.GeneralDAL();

            FrmCommon.App_Entities.GeneralEntity OdsSurveyAccess = new FrmCommon.App_Entities.GeneralEntity();
