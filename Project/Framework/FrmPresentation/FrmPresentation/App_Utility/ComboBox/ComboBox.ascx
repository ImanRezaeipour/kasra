<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ComboBox.ascx.cs" Inherits="frmpresentation.App_Utility.ComboBox.ComboBox" %>
<%@ Register TagPrefix="cc1" Namespace="KasraDll" Assembly="KasraDll" %>
<link href="/frmpresentation/App_Utility/ComboBox/Style/PersonComboStyle.css" rel="stylesheet" type="text/css" />
 <%--ie10--%>
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8" />

<asp:Literal ID="LitraltxtPCode" runat="server"></asp:Literal>

<script src="/FrmPresentation/App_Utility/ComboBox/ComboBox.js" type="text/javascript"></script>
<table border="0" id="TBMain" ismaintable="true" runat="server" dir="rtl" align="right"
    ...
    <tr>
        <td id="tdText" valign="middle">
            <asp:TextBox IsTxtCombo="True" timeout="" class="TxtControls" ID="txtPCode" OldVal="" onblur="onBlurtxtPCode(this)" 
                onclick="onFocusTxt(this)" runat="server" onkeydown="txtPCodeOnKeyDown(this)" oncontextmenu="txtPCodeonmousedown(this)" 
                Width="70px" AutoCompleteType="Disabled"></asp:TextBox>
        </td>
        ...
        <td id="Td1" runat="server" align="right" style="width: 160px; font-family: KasraTahoma;
            ...
            <asp:TextBox ID="txtName" runat="server" ReadOnly="true" Width="100px" Height="20px"
...
<div runat="server" iscombo="true" id="DivPopup" dir="rtl" style="border: 2px solid #858585;
    width: 211px; background-color: #FFFFF2; position: absolute; display: none;z-index: 1000">
