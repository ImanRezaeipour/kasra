...
var DateDirect = "Asc", PIDDirect = "Asc", PNameDirect = "Asc", DeptDirect = "Asc", DocTypeDirect = "Asc";
...
function OndbClickGrd() {
    if (AccessEdit == true && LastSelectedRow.StatusId != "205") {
        var url = "";
        var DialogProperty = "";
        switch (LastSelectedRow.TableName) {
            case "Att.Attendance":
...
function OnClickBtnAccept() {
    ...
    if (xmlNodes.length > 0) {
        ...
        var xmlNodes2 = xmlDoc2.documentElement.selectNodes("/BaseInfoEntity/GetCreditManage[Selected=1]");
...
function OnClickBtnNotAccept() {
    ...
    if (xmlNodes.length > 0) {
        ...
        if ($get(MasterObj + "txtFlagNotAccept").value == "1") {
            var url = "CardTableNotAcceptDesc.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
...
function OnClickChk(obj) {
    ...
    if ($get(MasterObj + "CmbShow").value == "16601") {
        ...
        var oXmlNodes2 = oXmlDoc2.documentElement.selectNodes("/BaseInfoEntity/GetCreditManage [ DocID=" + oGrid.rows(oIndex).DocID + "]");
        //========================================================
...
function OnClickBtnRegisterCredit() {
    var url = "/TAPresentation/App_Pages/DataEntry/RegisterCredit.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
...
function OnClickBtnAttendance() {
    var url = "/TAPresentation/App_Pages/DataEntry/RegisterGooing.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
...
function OnClickBtnDayContinuation() {
    var url = "/TAPresentation/App_Pages/DataEntry/RequestDayContinuation.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
...
function OnClickBtnMonthly() {
    var url = "/TAPresentation/App_Pages/DataEntry/RequestMonthlyItem.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
    returnValue = window.showModalDialog(encodeURI(url), window, "dialogHeight:280px;dialogWidth:630px;center: Yes;help: no;status: no")
    if (returnValue == 1)
        OnClickBtnFilter();
...
function OnClickBtnRepeatMonthlyItem() {
    var url = "/TAPresentation/App_Pages/DataEntry/RequestRepeatMonthlyItem.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
    returnValue = window.showModalDialog(encodeURI(url), window, "dialogHeight:280px;dialogWidth:630px;center: Yes;help: no;status: no")
    if (returnValue == 1)
        OnClickBtnFilter();
...
function OnClickBtnChangeStructure() {
    var url = "/TAPresentation/App_Pages/DataEntry/RegisterChangeStructure.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
    returnValue = window.showModalDialog(encodeURI(url), window, "dialogHeight:280px;dialogWidth:630px;center: Yes;help: no;status: no")
    if (returnValue == 1)
        OnClickBtnFilter();
...
function OnClickCreateDateTime(obj) {
    var url = "";
    var DialogProperty = "";
    switch (obj.parentElement.TableName) {
        case "Att.Attendance":
            url = "/TAPresentation/App_Pages/DataEntry/RegisterGooing.aspx";
            DialogProperty = "dialogHeight:280px;dialogWidth:630px;center: Yes;help: no;status: no";
            break;
...
function OnClickBtnReplaceShift() {
    if (LastSelectedRow != null && LastSelectedRow != undefined && LastSelectedRow != "" && LastSelectedRow.getAttribute("TableName") == "Att.ReplaceDetail") {
        var url = "/TAPresentation/App_Pages/DataEntry/SchedulingProg.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value + "&DocID=" + LastSelectedRow.DocID;
        ...
        alert("تغييرساختار مورد نظر را انتخاب کنید");
}
//----------------------------------------------------------------------------------------------------------------------
function OnClickBtnPersonShift() {

    if (LastSelectedRow != null && LastSelectedRow != undefined && LastSelectedRow != "" && LastSelectedRow.getAttribute("TableName") == "Att.ReplaceDetail") {
        var url = "/TAPresentation/App_Pages/DataEntry/SchedulingProgForPersonel.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value + "&DocID=" + LastSelectedRow.DocID;
        returnValue = window.showModelessDialog(encodeURI(url), window, "dialogHeight:900px;dialogWidth:1300px;center: Yes;help: no;status: no;resizable=1;minimize: yes")
    }
    else
...
function OnClickBtnErja() {
    ...
    if (xmlNodes.length > 0) {
        ...
        $get(MasterObj + "txtGridData").value = xmlDoc2.xml;
        //======================================================
        var URL = "/Ta/TAPeresentation/Pages/Person/PersonTab.aspx?flag=" + "Report" + " &TypeAccess=" + $get(MasterObj + "txtFlagAccess").value + " &MenuItemID=361109&SessionID=" + $get(MasterObj + "txtSessionID").value;
...
function OnClickBtnScheduleChange() {
    var url = "/TAPresentation/App_Pages/DataEntry/ShiftRequest.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
            + "&ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
