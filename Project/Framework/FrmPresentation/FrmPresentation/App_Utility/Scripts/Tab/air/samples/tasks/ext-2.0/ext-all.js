...
//        p = "tl-tr?";
    ...
    boxWrap : function(cls){
        cls = cls || 'x-box';
        var el = Ext.get(this.insertHtml('beforeBegin', String.format('<div dir="rtl" class="{0}">'+El.boxMarkup+'</div>', cls)));
...
El.boxMarkup = '<div dir="rtl" class="{0}-tl"><div class="{0}-tr"><div class="{0}-tc"></div></div></div><div class="{0}-ml"><div class="{0}-mr"><div class="{0}-mc"></div></div></div><div class="{0}-bl"><div class="{0}-br"><div class="{0}-bc"></div></div></div>';
...
Ext.extend(Ext.Updater, Ext.util.Observable, {
    ...
    update : function(url, params, callback, discardUrl){
        if(this.fireEvent("beforeupdate", this.el, url, params) !== false){
            ...
            if(typeof url == "object"){ 
                ...
                if(typeof cfg.text != "undefined"){this.indicatorText = '<div dir="rtl" class="loading-indicator">'+cfg.text+"</div>";};
   ...
   Ext.Updater.defaults = {
        ...
        indicatorText : '<div dir="rtl" class="loading-indicator">Loading...</div>'
   };
...
Ext.Shadow.Pool = function(){
    var p = [];
    var markup = Ext.isIE ?
                 '<div dir="rtl" class="x-ie-shadow"></div>' :
                 '<div dir="rtl" class="x-shadow"><div class="xst"><div class="xstl"></div><div class="xstc"></div><div class="xstr"></div></div><div class="xsc"><div class="xsml"></div><div class="xsmc"></div><div class="xsmr"></div></div><div class="xsb"><div class="xsbl"></div><div class="xsbc"></div><div class="xsbr"></div></div></div>';
    return {
        pull : function(){
            var sh = p.shift();
            if(!sh){
        ...
        if(!this.collapsedEl){
            if(!this.toolTemplate){
                var tt = new Ext.Template(
                     '<div dir="rtl" class="x-tool x-tool-{id}">&#160;</div>'
                );
...
Ext.layout.FormLayout = Ext.extend(Ext.layout.AnchorLayout, {
    ...
    labelSeparator : ':',
        ...
        if(!this.fieldTpl){
                ...
                '<div dir="rtl" class="x-form-item {5}" tabIndex="-1">',
                    '<label for="{0}" style="{2}" class="x-form-item-label">{1}{4}</label>',
                    '<div dir="rtl" class="x-form-element" id="x-form-el-{0}" style="{3}">',
                    '</div><div class="{6}"></div>',
                '</div>'
            );
...
Ext.Panel = Ext.extend(Ext.Container, {
    ...
    slideAnchor : 't',
        ...
        if(this.buttons && this.buttons.length > 0){
                ...
                html:'<table dir="rtl" cellspacing="0"><tbody><tr></tr></tbody></table><div class="x-clear"></div>'
            }}, null, true);
...
Ext.DataView = Ext.extend(Ext.BoxComponent, {
    ...
    onBeforeLoad : function(){
        if(this.loadingText){
            this.clearSelections(false, true);
            this.el.update('<div dir="rtl" class="loading-indicator">'+this.loadingText+'</div>');
            this.all.clear();
        }
    }
});
...
Ext.DatePicker = Ext.extend(Ext.Component, {
    ...
    onRender : function(container, position){
        var m = [
             '<table dir="rtl" cellspacing="0">',
                '<tr><td class="x-date-left"><a href="#" title="', this.prevText ,'">&#160;</a></td><td class="x-date-middle" align="right"></td><td class="x-date-right"><a href="#" title="', this.nextText ,'">&#160;</a></td></tr>',
        ...
        for(var i = 0; i < 42; i++) {
            ...
            m[m.length] = '<td dir="rtl"><a href="#" hidefocus="on" class="x-date-date" tabIndex="1"><em><span></span></em></a></td>';
        }
        m[m.length] = '</tr></tbody></table></td></tr><tr><td colspan="3" class="x-date-bottom" align="right"></td></tr></table><div class="x-date-mp"></div>';
    ...
    createMonthPicker : function(){
        if(!this.monthPicker.dom.firstChild){
            var buf = ['<table dir="rtl" border="0" cellspacing="0">'];
            for(var i = 0; i < 6; i++){
                buf.push(
                    '<tr><td class="x-date-mp-month"><a href="#">', this.monthNames[i].substr(0, 3), '</a></td>',
                    '<td dir="rtl" class="x-date-mp-month x-date-mp-sep"><a href="#">', this.monthNames[i+6].substr(0, 3), '</a></td>',
                    i == 0 ?
                    '<td dir="rtl" class="x-date-mp-ybtn" align="right"><a class="x-date-mp-prev"></a></td><td class="x-date-mp-ybtn" align="right"><a class="x-date-mp-next"></a></td></tr>' :
                    '<td dir="rtl" class="x-date-mp-year"><a href="#"></a></td><td class="x-date-mp-year"><a href="#"></a></td></tr>'
                );
            }
            buf.push(
    ...
    initComponent : function(){
        ...
        if(!this.template){
            if(!Ext.Button.buttonTemplate){
                    ...
                    '<table dir="rtl" border="0" cellpadding="0" cellspacing="0" class="x-btn-wrap"><tbody><tr>',
                    '<td dir="rtl" class="x-btn-left"><i>&#160;</i></td><td class="x-btn-center"><em unselectable="on"><button class="x-btn-text" type="{1}">{0}</button></em></td><td class="x-btn-right"><i>&#160;</i></td>',
                    "</tr></tbody></table>");
            }
...
Ext.SplitButton = Ext.extend(Ext.Button, {
    ...
    onRender : function(ct, position){
        ...
        var tpl = new Ext.Template(
            '<table dir="rtl" cellspacing="0" class="x-btn-menu-wrap x-btn"><tr><td>',
            '<table dir="rtl" cellspacing="0" class="x-btn-wrap x-btn-menu-text-wrap"><tbody>',
            '<tr><td class="x-btn-left"><i>&#160;</i></td><td class="x-btn-center"><button class="x-btn-text" type="{1}">{0}</button></td></tr>',
            "</tbody></table></td><td>",
            '<table dir="rtl" cellspacing="0" class="x-btn-wrap x-btn-menu-arrow-wrap"><tbody>',
...
Ext.extend(T, Ext.BoxComponent, {
    ...
    autoCreate: {
        ...
        html:'<table dir="rtl" cellspacing="0"><tr></tr></table>'
    },
        ...
        getDialog : function(titleText){
           if(!dlg){
                ...
                bodyEl = dlg.body.createChild({
                    html:'<div dir="rtl" class="ext-mb-icon"></div><div class="ext-mb-content"><span class="ext-mb-text"></span><br /><input type="text" class="ext-mb-input" /><textarea class="ext-mb-textarea"></textarea></div>'
                });
...
Ext.tree.TreeNodeUI.prototype = {
    ...
    renderElements : function(n, a, targetNode, bulkRender){
        ...
        var buf = ['<li class="x-tree-node"><div dir ext:tree-node-id="',n.id,'" class="x-tree-node-el x-tree-node-leaf x-unselectable ', a.cls,'" unselectable="on">',
...
Ext.tree.RootTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    ...
    render : function(){
        if(!this.rendered){
            ...
            targetNode.innerHTML = '<div dir="rtl" class="x-tree-root-node"></div>';
...
Ext.form.ComboBox = Ext.extend(Ext.form.TriggerField, {
    ...
    setEditable : function(value){
        ...
        this.innerList.update(this.loadingText ?
               '<div dir="rtl" class="loading-indicator">'+this.loadingText+'</div>' : '');
        this.restrictHeight();
        this.selectedIndex = -1;
    },
    ...
    syncValue : function(){
        if(this.initialized){
            ...
            if(Ext.isSafari){
                ...
                if(m && m[1]){
                    html = '<div dir="rtl" style="'+m[0]+'">' + html + '</div>';
                }
            }
...
Ext.extend(Ext.grid.GridView, Ext.util.Observable, {
    ...
    columnsText : "Columns",
        ...
        if(!ts.master){
            ts.master = new Ext.Template(
                    '<div dir="rtl" class="x-grid3" hidefocus="true">',
                        '<div dir="rtl" class="x-grid3-viewport">',
                            '<div dir="rtl" class="x-grid3-header"><div class="x-grid3-header-inner"><div class="x-grid3-header-offset">{header}</div></div><div class="x-clear"></div></div>',
                            '<div dir="rtl" class="x-grid3-scroller"><div class="x-grid3-body">{body}</div><a href="#" class="x-grid3-focus" tabIndex="-1"></a></div>',
                        "</div>",
                        '<div dir="rtl" class="x-grid3-resize-marker">&#160;</div>',
                        '<div dir="rtl" class="x-grid3-resize-proxy">&#160;</div>',
                    "</div>"
                    );
        }
        ...
        if(!ts.header){
            ts.header = new Ext.Template(
                    '<table dir="rtl" border="0" cellspacing="0" cellpadding="0" style="{tstyle}">',
        ...
        if(!ts.hcell){
            ts.hcell = new Ext.Template(
                    '<td dir="rtl" class="x-grid3-hd x-grid3-cell x-grid3-td-{id}" style="{style}"><div {tooltip} {attr} class="x-grid3-hd-inner x-grid3-hd-{id}" unselectable="on" style="{istyle}">', this.grid.enableHdMenu ? '<a class="x-grid3-hd-btn" href="#"></a>' : '',
        ...
        if(!ts.row){
            ts.row = new Ext.Template(
                    '<div dir="rtl" class="x-grid3-row {alt}" style="{tstyle}"><table class="x-grid3-row-table" border="0" cellspacing="0" cellpadding="0" style="{tstyle}">',
                    '<tbody><tr>{cells}</tr>',
        ...
        if(!ts.cell){
            ts.cell = new Ext.Template(
                    '<td dir="rtl" class="x-grid3-col x-grid3-cell x-grid3-td-{id} {css}" style="{style}" tabIndex="0" {cellAttr}>',
                    '<div dir="rtl" class="x-grid3-cell-inner x-grid3-col-{id}" unselectable="on" {attr}>{value}</div>',
                    "</td>"
                    );
        }
    ...
    refresh : function(headersToo){
        ...
        if(this.emptyText && !this.hasRows()){
            this.mainBody.update('<div dir="rtl" class="x-grid-empty">' + this.emptyText + '</div>');
        }
    },
    ...
    initTemplates : function(){
        ...
        if(!this.startGroup){
            this.startGroup = new Ext.XTemplate(
                '<div dir="rtl" id="{groupId}" class="x-grid-group {cls}">',
                    '<div dir="rtl" id="{groupId}-hd" class="x-grid-group-hd" style="{style}"><div>', this.groupTextTpl ,'</div></div>',
                    '<div dir="rtl" id="{groupId}-bd" class="x-grid-group-body">'
            );
        }
...
Ext.grid.CheckboxSelectionModel = Ext.extend(Ext.grid.RowSelectionModel, {
    ...
    header: '<div dir="rtl" class="x-grid3-hd-checker">&#160;</div>',
    ...
    renderer : function(v, p, record){
        return '<div dir="rtl" class="x-grid3-row-checker">&#160;</div>';
    }
});
...
Ext.ProgressBar = Ext.extend(Ext.BoxComponent, {
    ...
    onRender : function(ct, position){
        ...
        var tpl = new Ext.Template(
            '<div dir="rtl" class="{cls}-wrap">',
                '<div dir="rtl" class="{cls}-inner">',
                    '<div dir="rtl" class="{cls}-bar">',
                        '<div dir="rtl" class="{cls}-text">',
                            '<div dir="rtl">&#160;</div>',
                        '</div>',
                    '</div>',
                    '<div dir="rtl" class="{cls}-text {cls}-text-back">',
                        '<div dir="rtl">&#160;</div>',
                    '</div>',
                '</div>',
            '</div>'
...
function createConsole(){
    ...
    cp = new Ext.Panel({
        ...
        collapsible: true,
        animCollapse: false,
        style: 'position:absolute;  text-align: right;left:0;bottom:0;',
        height:200,
        logView: logView,
        layout: 'fit',
...
Ext.debug.LogPanel = Ext.extend(Ext.Panel, {
    ...
    log : function(){
        var markup = [  '<div dir="rtl" style="padding:5px !important;border-bottom:1px solid #ccc;">',
