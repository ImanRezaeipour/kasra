...
{
    public partial class NewToolBar : System.Web.UI.UserControl
    {
      ...
      //  private int SolutionId;
        ...
        private void CreateToolBar()
        {
            ...
            CtrlsDataMask.FillDatasetBySP(CtrlsDataMask.SqlConnectionType.GenCnn, this.spName, ods, new string[] { "OnlineUserPageAccess" }, _OnlineUserId, 1, this.SubSysId, _PageID);
            DataRow[] dr;
            ...
            ////==============TdMainBtn
            //this.StrHtml += "<td    valign='middle' align='left'  ><div  onmouseover='onMouseOverDiv(this)' onmouseout='onMouseDown(this)' onclick='onclickHidden(" + '"' + ControlID + '"' + ",this);onclickXTableToolBar(this);' style='width:30px;' align='center'><img id='" + ControlID + "_" + "btnHidden' src='/FrmPresentation/App_Utility/Images/Icons/Up3.gif'  style='display:inline; height: 5px;width:8px;' /><img id='" + ControlID + "_" + "btnShow' src='/FrmPresentation/App_Utility/Images/Icons/down3.gif' style='display:none;height: 5px;width:8px;'  /></div></td><td align='right' style='width:70%;height:22px'><input id='" + ControlID + "_" + "txtMsgAlert' runat='server' readonly title='پيغامها' style='background-color:Transparent;border-width: 0px;color:Black; font-size: medium;width:100%;' disabled=true align='middle' dir='rtl'/></td>";
        ...
        private string CreateCells( DataRow[] dr)
        {
            ...
            string ControlID = this.ID;
                ...
                //StrTemp += "</td>";
                //StrTemp += "<td onclick='onclickXTableToolBar(this)' valign='top'>";
                ////===========================ProgressBar
                ...
                for (int i = 0; i < dr.Length; i++)
                {
                    ...
                    StrTemp += "<td><div id='" + ControlID + "_" + dr[i]["AccessCode"].ToString().Trim() + "' onclick='OnClick" + dr[i]["AccessCode"].ToString().Trim() + "()' onmouseover='onMouseOverDiv(this)' onmouseout='onMouseDown(this)' style='border-left-style: groove;border-left-color: #FFFFFF; border-left-width: thin;'  align='right' title='" + dr[i]["ShortKey"].ToString() + "   " + dr[i]["ActionAccessDescr"].ToString() + "'>";
