<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CodeCondition.ascx.cs" Inherits="FrmPresentation.App_Utility.CodeCondition.CodeCondition" %>
...
//            document.getElementById(ThisID + "_txtAcronym").value = "Condition"
                ...
                if (document.getElementById(ThisID + "_txtAcronym").value == "")
                    document.getElementById(ThisID + "_txtAcronym").value = "Report"
                 var strUrl = "/FrmPresentation/App_Utility/CodeCondition/CodeCondition.aspx?txtHidden=" + document.getElementById(ThisID + "_txtAcronym").value
