<%@ Page Title="طراحی گزارش" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master"
    AutoEventWireup="true" CodeBehind="ReportDesign.aspx.cs" Inherits="FrmPresentation.App_Pages.FormGenerator.ReportDesign" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <cc1:StiWebViewer ID="StiWebViewer1" RenderMode="AjaxWithCache"  ServerTimeOut="0"  runat="server" />      
