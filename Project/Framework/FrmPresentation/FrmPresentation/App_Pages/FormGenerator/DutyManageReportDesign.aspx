<%@ Page Title="" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="DutyManageReportDesign.aspx.cs" Inherits="FrmPresentation.App_Pages.FormGenerator.DutyManageReportDesign" %>
...
<div style="display:none">
    ...
    <input id="txtPCode" name="txtPCode" type="text" runat="server"  /> 
    <input id="txtSerialNoSearch" name="txtSerialNoSearch" type="text" runat="server"  /> 
    <input id="txtCreditType" name="txtCreditType" type="text" runat="server"  /> 
    <input id="txtStatus" name="txtStatus" type="text" runat="server"  />
    <input id="txtSortExpression" name="txtSortExpression" type="text" runat="server"  />
