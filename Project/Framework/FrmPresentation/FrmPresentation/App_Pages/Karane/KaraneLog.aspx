<%@ Page Title="-----------------------------------------------------------------------------------نمايش لاگ------------------------------------------------------------------------------------------------" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="KaraneLog.aspx.cs" Inherits="FrmPresentation.App_Pages.Karane.KaraneLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <script>
       ...
       function OnClickBtnFilter() {
           if ($get(MasterObj + "CmbKaraneRptName").value == "0") {
               alert("لطفا آيتم کارانه مورد نظر را انتخاب نماييد");
               $get(MasterObj + "CmbKaraneRptName").focus();
           }
           else if ($get(MasterObj + "CmbWorkPeriod").value == "0") {
               alert("لطفا دوره مورد نظر را انتخاب نماييد");
               $get(MasterObj + "CmbWorkPeriod").focus();
           }
           else if ($get(MasterObj + "CmbDept").value == "0") {
               alert("لطفا واحد سازماني مورد نظر را انتخاب نماييد");
               $get(MasterObj + "CmbDept").focus();
           }
           else {
