<%@ Page Title="-------------------------------------------------------------------------------------------------------------------تعريف آيتم کارانه-----------------------------------------------------------------------------------------------------" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="KaraneReportDefinition.aspx.cs" ValidateRequest="false"  Inherits="FrmPresentation.App_Pages.Karane.KaraneReportDefinition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display: none">
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <input type="hidden" id="txtReportID" name="txtReportID" runat="server" />
            </ContentTemplate>
            <Triggers>
    ...
    <script >
        ...
        function OnClickBtnSave() {
            ...
            //------------------------------------------
            if ($get(MasterObj + "txtReportID").value == "0" || $get(MasterObj + "txtReportID").value == "")
