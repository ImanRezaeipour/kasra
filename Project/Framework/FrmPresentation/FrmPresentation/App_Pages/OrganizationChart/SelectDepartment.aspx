<%@ Page Title="" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="SelectDepartment.aspx.cs" Inherits="FrmPresentation.App_Pages.OrganizationChart.SelectDepartment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table scroll="no">
        <tr>
            <td align="right" valign="top">
                <table style="height: 499px; width: 705px;">
                    <tr>
                    ...
                    <tr>
                        <td align="center" valign="top" style="height: 406px">
                            <table style="width: 100%">
                                <tr>
                                    <td id="TDTree" align="right" valign="top" style="width: 171px; height: 311px">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <div style="width: 260px; height: 440px;" class="BlueScroll">
    ...
    <script src="../../App_Utility/Scripts/BaseInfo/OrganizationChart/SelectDepartment.js"
