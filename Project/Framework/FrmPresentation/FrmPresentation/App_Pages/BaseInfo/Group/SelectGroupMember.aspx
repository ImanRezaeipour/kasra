<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectGroupMember.aspx.cs"
    Inherits="FrmPresentation.App_Pages.BaseInfo.Group.SelectGroupMember" MasterPageFile="../../../App_Utility/MasterPage/MasterBule.master"
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <input id="txtPersonCode" name="txtPersonCode" type="text" runat="server" dir="rtl"
                                             onblur="OnBlurTxtPersonCode()" style="width: 60px" />
                                    </td>
                                    <td >
                                        نام و نام خانوادگی:
                                    </td>
                                    ...
                                    <td >
                                        <asp:DropDownList ID="CmbGroup" runat="server" Width="100px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
