<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PageNotFound.aspx.vb" Inherits="TA.PageNotFound" %>
				...
				<TR>
					<TD vAlign="middle" align="center">
						<TABLE class="CssLayer2" id="Layer2" height="100%" cellSpacing="0" cellPadding="0" width="100%"
							...
							<TR>
								<TD vAlign="middle" align="center">
									<TABLE class="CssPage" id="Layer3" height="179" cellSpacing="0" cellPadding="0" width="417"
										border="0" style="WIDTH: 417px; HEIGHT: 179px">
										<TR>
											<TD class="VertGradientBlue1" style="HEIGHT: 60px" vAlign="middle" align="center"><IMG id="ImgError" alt="" src="../../../Includes/Images/CustomError/attention.gif" name="ImgError"
