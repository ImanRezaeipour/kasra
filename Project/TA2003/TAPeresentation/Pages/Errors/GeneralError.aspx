<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GeneralError.aspx.vb" Inherits="TA.GeneralError" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML dir="rtl">
	<HEAD>
		<title>------------------------------------------------------------------·ÿ›« »« „œÌ— ”Ì” „  „«” »êÌ—Ìœ---------------------------------------------------------------</title>
							...
							<TR>
								<TD vAlign="middle" align="center">
									<TABLE class="CssPage" id="Layer3" height="182" cellSpacing="0" cellPadding="0" width="401"
										...
										<TR>
											<TD class="VertGradientBlue1" style="HEIGHT: 53px" vAlign="middle" align="center"><IMG id="ImgError" alt="" src="../../../Includes/Images/CustomError/attention.gif" name="ImgError"
