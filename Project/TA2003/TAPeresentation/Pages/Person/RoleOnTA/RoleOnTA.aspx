<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RoleOnTA.aspx.vb" Inherits="TA.RoleOnTA" %>
<%@ Register TagPrefix="cc1" Namespace="WEBLib" Assembly="WEBLib" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>RoleOnTA</title>
													...
													<TR>
														<TD style="BORDER-RIGHT: lightblue thin inset; BORDER-TOP: lightblue thin solid; BORDER-LEFT: lightblue thin outset; WIDTH: 200px; BORDER-BOTTOM: lightblue thin solid; HEIGHT: 388px"
															...
															<IFRAME id="FTree" style="WIDTH: 100.56%; HEIGHT: 99.98%" align="right" marginWidth="0"
																marginHeight="0" src='FrameTreeOnTa.aspx?SessionID=<%=request("SessionID")%>' frameBorder="no" width="100%" scrolling="no" height="100%">
															</IFRAME>
														</TD>
														<TD><IFRAME id="FrameGridPersons" style="WIDTH: 100.56%; HEIGHT: 99.98%" align="right" marginWidth="0"
																marginHeight="0" src='SingleRoleTabOnTa.aspx?SessionID=<%=request("SessionID")%>' frameBorder="no" width="100%" scrolling="no"
																height="100%"></IFRAME>
														</TD>
													</TR>
												</TABLE>
