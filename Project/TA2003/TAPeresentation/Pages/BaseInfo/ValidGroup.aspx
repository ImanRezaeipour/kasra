...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ValidGroup.aspx.vb" Inherits="TA.ValidGroup" validateRequest="false" %>
...
<HTML>
	<HEAD>
		...
		function chkOnClick(chk)
		{
			...
			if (Form1.txtCategoryId.value==-1)
			{
				var xmlNodes1;
				xmlNodes1=xmlDoc.documentElement.selectNodes(root);
				ll=xmlNodes1.length
				for(j=0;j<ll;j++)
				{
					xmlNodes1.item(j).selectSingleNode('Selected').text=0
				}
			}
			if (chk.checked)
		...
		function AddRow(oGrid,AttrName,AttrValue,cntRow,Selected,Param)
		{
				...
				{
					if (Selected==1)
						oGrid.rows(newrowindex).cells(1).innerHTML="<input type='radio' checked name='Group' onclick='chkOnClick(this)'/>"
					else
						oGrid.rows(newrowindex).cells(1).innerHTML="<input type='radio' name='Group' onclick='chkOnClick(this)'/>"
				}
				else
				{
					if (Selected==1)
			...
			<TABLE class="CssLayer2" id="Layer1" height="100%" cellSpacing="0" cellPadding="0" width="100%"
														...
														<TD>
															<TABLE id="Table6" style="WIDTH: 447px; HEIGHT: 49px" cellSpacing="1" cellPadding="1" width="447"
																...
																<TR>
																	...
																	<TD style="WIDTH: 216px"> ⁄œ«œ&nbsp;ê—ÊÂÂ«Ì&nbsp;œ— Õ«· ‰„«Ì‘:</TD>
													...
													<TABLE id="XTabTable_Header">
														<THEAD style="DISPLAY: inline">
															<TR class="ShoperHeaderStyle">
																<TD class="Headerstyle" align="center" width="30" style="FONT-FAMILY: Arial">*</TD>
																...
																<Td width="150" align="center" class="Headerstyle">‰«„ ê—ÊÂ</Td>
															</TR>
														</THEAD>
													</TABLE>
				...
				<tr>
					<td style="DISPLAY: none">
						<input id="txtCategoryId" name="txtCategoryId" type="text" runat="server"> <input id="txtFlag" name="txtFlag" type="text" runat="server">
					</td>
				</tr>
			</TABLE>
		</form>
