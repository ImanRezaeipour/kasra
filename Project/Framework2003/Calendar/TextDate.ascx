<%@ Control Language="vb" AutoEventWireup="false" Codebehind="TextDate.ascx.vb" Inherits="FrameWork.TextDate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script language="javascript" src="/Framework/Calendar/Scripts/JScripts/TextDate.js"></script>
<script language="javascript" src="/Framework/Calendar/Scripts/JScripts/KasraDate.js"></script>
		...
		<td vAlign="top" align="right">
			<table dir="rtl" style="BORDER-RIGHT: #b0c4de 2px groove; BORDER-TOP: #b0c4de 2px groove; BORDER-LEFT: #b0c4de 2px groove; WIDTH: 128px; BORDER-BOTTOM: #b0c4de 2px groove; HEIGHT: 8px"
				...
				<tr>
					...
					<TD id="btnShowCalender" style="BACKGROUND-IMAGE: url(/Framework/Calendar/Images/calendar2.GIF); WIDTH: 22px; BORDER-TOP-STYLE: none; BACKGROUND-REPEAT: no-repeat; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; HEIGHT: 16px; BORDER-BOTTOM-STYLE: none"
					...
					<td style="DISPLAY: none"><input id="txtKeyCodeHid" style="WIDTH: 10px" type="hidden" name="txtKeyCodeHid" runat="server">
						<input id="txtFocusTextsHid" style="WIDTH: 10px" type="hidden" name="txtFocusTextsHid"
							...
							runat="server"><input type="text" id="txtXmlHoliday" runat="server">
					</td>
				</tr>
			</table>
		</td>
...
<script language="vbscript" src="../Calendar/Scripts/VBScripts/TextDate.vbs"></script>
