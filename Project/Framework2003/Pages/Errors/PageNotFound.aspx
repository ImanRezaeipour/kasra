<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PageNotFound.aspx.vb" Inherits="FrameWork.PageNotFound" %>
							...
							<TR>
								<TD vAlign="middle" align="center">
									<TABLE class="CssPage" id="Layer3" height="179" cellSpacing="0" cellPadding="0" width="417"
										...
										<TR>
											<TD class="VertGradientBlue1" style="HEIGHT: 60px" vAlign="middle" align="center"><IMG id="ImgError" alt="" src="../../Images/CustomError/attention.gif" name="ImgError"
