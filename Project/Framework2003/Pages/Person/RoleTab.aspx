...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RoleTab.aspx.vb" Inherits="FrameWork.RoleTab" validateRequest="false" %>
...
<HTML>
	<HEAD>
		...
		{
			var RoleID
			RoleID=chk.parentElement.parentElement.RoleID
			xmlDoc = new ActiveXObject("MsXml2.DomDocument");
			xmlDoc.loadXML(Form1.XMLX.value);
			xmlDoc.setProperty("SelectionLanguage", "XPath");
	
			var xmlNodes;
			xmlNodes=xmlDoc.documentElement.selectNodes(root+"[RoleID="+RoleID+"]");
									...
									<TABLE id="Table2" style="WIDTH: 606px; HEIGHT: 378px" cellSpacing="1" cellPadding="1"
										...
										<TR>
											<td style="DISPLAY: none"><INPUT id="XMLSelected" style="DISPLAY: none" size="1" name="XMLSelected" runat="server">
												<INPUT id="XMLX" style="WIDTH: 1px; DISPLAY: none" name="XMLX" runat="server"> <input id="txtSessionID" name="txtSessionID" runat="server">
