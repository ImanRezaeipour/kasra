<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SingleRoleTab1.aspx.vb" Inherits="FrameWork.SingleRoleTab1" validateRequest="false" %>
...
<HTML dir="rtl">
	<HEAD>
		...
		<LINK href="../../../Includes/XTab.css" type="text/css" rel="stylesheet">
		<LINK href="../../../Includes/XSelectionStyle.css" type="text/css" rel="stylesheet">
		<LINK href="../../../Includes/Paging.css" type="text/css" rel="stylesheet">
		...
		function XTabShowAll()
		{
			...
			FillTabTable('First')
			window.parent.frames('FTree').location='FrameTree.aspx?DepartmentId=0'+'&SessionID='+Form1.txtSessionID.value ;
		}
		////////////////////////////////////////////////////////////////////////////////
		function XTabSearch()
		{
		...
		function chkOnClick(chk)
		{
			...
			if (xmlNodes.length!=0)
			{
				if (chk.checked)
				{
					...
					window.parent.frames('FTree').location='FrameTree.aspx?DepartmentId='+Form1.RoleId.value+'&SessionID='+Form1.txtSessionID.value ;
				}	
				else
						...
						<TABLE id="Table2" style="WIDTH: 416px; HEIGHT: 304px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								<TD style="DISPLAY: none"><INPUT id="XMLSelected" style="DISPLAY: none" size="1" name="XMLSelected" runat="server">
									...
									<input id="txtSessionID" runat="server"> <input id="txtGetCompanyFinatialPeriodID" name="txtGetCompanyFinatialPeriodID" runat="server">
								</TD>
							</TR>
						</TABLE>
					</TD>
