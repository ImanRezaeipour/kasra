<%@ Page Title="" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="KaraneGeneratorNew.aspx.cs" Inherits="TAPresentation.App_Pages.Karane.KaraneGeneratorNew" %>
       ...
       //-------------------------------Declaration----------------------------------------------------
        ...
        function BeginRequestHandler(sender, args) {
            ...
            if (StrVal != "Save" && StrVal != "Confirm" && StrVal != "NotAccept" && StrVal != "Filter") {
                ...
                if (OGrid)
                    ...
                    return
                if (OGrid.rows(len - 3).cells(i) && OGrid.rows(len - 3).cells(i).innerText == "")
                    idx = len - 3
                else if (OGrid.rows(len - 2).cells(i) && OGrid.rows(len - 2).cells(i).innerText == "")
                    idx = len - 2
                //--------------------------------------------------
                if (OGrid) {
                    //----------------------------------------------
        ...
        function EndRequestHandler(sender, args) {
            ...
            || $get(MasterObj + 'txtStatusID').value != "1") {
                    ...
                    document.getElementById('OToolBar_BtnErjaToStepBefor').style.display = "inline";
                    document.getElementById('OToolBar_BtnErjaForReport').style.display = "inline";
        ...
        function SetSumRowColor() {
            ...
            if (oGrd)
                ...
                return
            if (oGrd.rows(len - 3).cells(i) && oGrd.rows(len - 3).cells(i).innerText == "")
                idx = len - 3
            else if (oGrd.rows(len - 2).cells(i) && oGrd.rows(len - 2).cells(i).innerText == "")
                idx = len - 2
            try {
                if (idx != 0) {
