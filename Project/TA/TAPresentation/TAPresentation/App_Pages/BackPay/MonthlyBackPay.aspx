<%@ Page Title="" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="MonthlyBackPay.aspx.cs" AsyncTimeout="7200" Inherits="TAPresentation.App_Pages.BackPay.MonthlyBackPay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" AsyncPostBackTimeout="400000000" runat="server">
    <table width="100%" >
        <tr>
            <td>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div id="DivGrid" class="DivStyle1">
                            <cc2:KasraGrid ID="GrdMonthlyBackPay" runat="server" OnRowDataBound="Grid_RowDataBound"
   ...
   <script>
       ...
       function OnDblClickGrd() {
           var url = "BackPayNew.aspx?ToPersonId=" + document.getElementById(MasterObj + "txtOnLineUser").value
                + "&SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
                + "&BackID=" + LastSelectedRow.getAttribute("BackID")
                + "&WPID=" + LastSelectedRow.getAttribute("WPID")
                + "&Descr=" + LastSelectedRow.cells(4).innerText
                + "&BPName=" + LastSelectedRow.cells(0).innerText
           var DialogProperty = "dialogHeight:200px;dialogWidth:750px;center: Yes;help: no;status: no;resizable=1"
       ...
       function OnClickBtnNew() {
           var url = "BackPayNew.aspx?BackID=0&SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
           var DialogProperty = "dialogHeight:200px;dialogWidth:750px;center: Yes;help: no;status: no;resizable=1"
       ...
       function OnClickBtnDel() {
           if (LastSelectedRow != null) {
               if (confirm("آيا براي حذف مطمئنيد؟")) {
                   document.getElementById(MasterObj + "txtBackID").value = LastSelectedRow.getAttribute("BackID")
       ...
       //===============================================================================================
       function OnClickBtnBackPayReport() {
           var url = "BackPayReport.aspx?SessionID=" + document.getElementById(MasterObj + "txtSessionID").value
           var DialogProperty = "dialogHeight:150px;dialogWidth:550px;center: Yes;help: no;status: no;resizable=1"
           returnValue = window.showModalDialog(url, "", DialogProperty);
       }
       //===============================================================================================
   </script>
