<%@ Page Title="" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="FractionCardex.aspx.cs" Inherits="TAPresentation.App_Pages.Cardex.FractionCardex" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div id="GridViewCountainer" class="DivStyle">
                            <cc2:KasraGrid ID="GrdFractionCardex" runat="server" OnRowDataBound="Grid_RowDataBound"
                                AllowSorting="true" OnSorting="GrdFractionCardex_Sorting">
                            </cc2:KasraGrid>
                        </div>
                    </ContentTemplate>
                    <Triggers>
    ...
    <script src="../../App_Utility/Scripts/Cardex/FractionCardex.js" type="text/javascript"></script>
</asp:Content>
