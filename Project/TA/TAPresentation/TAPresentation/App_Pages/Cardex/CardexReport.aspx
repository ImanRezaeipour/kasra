<%@ Page Title="---------------------------------------------------------------------------نمايش کاردکس--------------------------------------------------------------------------"
 Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" AsyncTimeout="7200" CodeBehind="CardexReport.aspx.cs" Inherits="TAPresentation.App_Pages.Cardex.CardexReport" %>
        ...
        <tr>
            <td>
                <fieldset dir="rtl" class="fieldsetStyle">
                    ...
                    <table align="right" width="800px" cellpadding="0" cellpadding="0" >
                        <tr>
                            <td>
                                پرسنلي :
                            </td>
                            ...
                            <td>
                                <asp:DropDownList ID="CmbWorkPeriod" name="CmbWorkPeriod" Width="130px" class="TxtControls"
                                    runat="server">
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList ID="CmbCardexPeriod" name="CmbCardexPeriod" Width="190px" class="TxtControls"
                                    runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div id="GridViewCountainer"  align="center" class="DivStyle1">
                            <cc2:KasraGrid ID="GrdCardexReport" runat="server" OnRowDataBound="Grid_RowDataBound"
                                AllowSorting="false" OnSorting="Grd_Sorting"   AllowSendToPDF="false" AllowSendToExcel="true">
                            </cc2:KasraGrid>
                        </div>
