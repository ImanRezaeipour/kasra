<%@ Page Title="---------------------------------------------------------------تعريف قوانين اعطاء به کاردکس-----------------------------------------------------------------"  Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" AutoEventWireup="true" CodeBehind="DefineCardexRule.aspx.cs" Inherits="TAPresentation.App_Pages.DataEntry.DefineCardexRule" %>
...
<script src="../../App_Utility/Scripts/General.js" type="text/javascript"></script>
    ...
    <table  align="center" style="width: 747px">
        <tr>
            <td  width="760px" align="center">
                <asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
                <uc1:ToolBar ID="OToolBar" runat="server" PageName="DefineCardexRule.aspx" Paging="1" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OndbClickGrd() {
            ...
            if (LimitedID == "") {
                ...
                var strUrl = "DefineCardexRuleModal.aspx?ID=" + LastSelectedRow.getAttribute("ID")
        ...
        function OnClickBtnNew() {
            var strUrl = "DefineCardexRuleModal.aspx?ID=0&ToPersonId=" + $get(MasterObj + "txtOnLineUser").value
                                + "&SessionID=" + $get(MasterObj + "txtSessionID").value
