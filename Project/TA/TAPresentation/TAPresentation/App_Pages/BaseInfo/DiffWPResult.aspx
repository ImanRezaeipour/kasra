<%@ Page Title="" Language="C#" MasterPageFile="~/App_Utility/MasterPage/MasterBule.master" ValidateRequest="false"  AutoEventWireup="true" CodeBehind="DiffWPResult.aspx.cs" Inherits="TAPresentation.App_Pages.BaseInfo.DiffWPResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <fieldset dir="rtl" class="DivSearchStyle">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="CmbShowDiffDaily" CssClass="TxtControls" runat="server" Width="120px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
 ...
 <script language="javascript" src="../../App_Utility/Scripts/BaseInfo/DiffWPResult.js" type="text/javascript"></script>  
