<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PersonComboBox.ascx.cs" Inherits="TAPresentation.App_Utility.PersonComboBox.PersonComboBox" %>
<style type="text/css">
    ...
    .CssBtnDown
    {
        ...
        border-style: none;
        background-image: url('/TaPresentation/App_Utility/PersonComboBox/Icon/Down.gif');
        cursor:pointer;
    }
    .CssBtnDown:hover
    {
        ...
        background-color: #CFD3D0;
        border-style: none;
        background-image: url('/TaPresentation/App_Utility/PersonComboBox/Icon/DownHover.gif');
        cursor:pointer;
    }
    .CssText
    {
        ...
        <table border="0" id="TBMain" IsMainTable="true" runat="server"  dir="rtl" align="right" 
                ...
                <tr>
                    ...
                    <td runat="server" id="tdDisplayName" align="right" style="width:160px; font-family: tahoma; font-size: 12px; font-weight: bold;">
                        <asp:TextBox ID="txtDisplayName" runat="server" ReadOnly="true" Width="90%" Height="100%" BorderStyle="None" BackColor="Transparent" Font-Names="KasraTraffic" Font-Size="12px" Font-Bold="True" ForeColor="#006600"></asp:TextBox>
                    </td>
                </tr>
