...
function OnClickBtnNew() {
    ...
    if ($get(MasterObj + "KCalSDate_txtCalendar")) {
...
function chkIsEmpty() {
    ...
    if (document.getElementById(MasterObj + "CmbMojavez").value == "0") {
...
function OnClickBtnSelectGroup() {
    ...
    var rValue = window.showModalDialog(strUrl, window, 'dialogHeight: 400px;dialogWidth: 500px;center: Yes;help: no;status: no;scroll:no')
